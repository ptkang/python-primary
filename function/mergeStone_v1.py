...
@LastEditTime: 2019-11-26 21:48:13
...
def l3_merge_l4():
    stone, gold, vit = l1_merge_l3()
    return (stone + 16) / 0.4878, (gold + 0.897) / 0.4878, vit / 0.4878 + 10

def l4_merge_l6():
    stone, gold, vit = l3_merge_l4()
    return stone * 13, gold * 12 + 19.75, vit * 12 + 10

stone, gold, vit = l4_merge_l6()
print("stone=%f, gold=%f, vit=%f" % (stone, gold, vit))

total_gold = stone * 0.75 + (stone * 8) * 0.05 + vit * 1
print("total_gold = " + str(total_gold))